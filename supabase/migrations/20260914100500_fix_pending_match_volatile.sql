-- get_pending_game_match foi criada `stable` por engano: ela faz a expiração
-- lazy (UPDATE) antes de ler, e o PostgREST roda funções stable numa
-- transação read-only, o que quebra o UPDATE com 25006 ("cannot execute
-- UPDATE in a read-only transaction"). Recriada como volatile (default).
