-- A folha "Editar Compartilhamento" que aparece quando o proprio dono
-- visualiza seu link publico precisa saber DE QUAL CONTA esse perfil e,
-- pra abrir a tela certa (perfil publico agora e por conta). O id em si
-- e opaco e so serve pra quem ja e o dono navegar pra propria tela de
-- configuracao -- nao da acesso a nada que o resto do payload publico ja
-- nao mostra (get_my_public_profile_settings continua exigindo ownership).
