...
import 'package:fifa_queue/features/requests/data/repositories/local_requests_repository.dart';
...
void registerRequestsModule(GetIt sl, {required SupabaseClient? supabaseClient}) {
  ...
  // Singleton: alimenta tanto a tela Solicitacoes quanto o badge da bottom
  // nav, que precisa do total pendente mesmo fora da tela.
  sl.registerLazySingleton<RequestsCubit>(
